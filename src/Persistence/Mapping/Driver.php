...
final class Driver implements MappingDriver
{
    ...
    public function loadMetadataForClass($className, ClassMetadata $metadata): void
    {
        ...
        switch ($className) {
            case ClientExtension::class:
                $this->buildClientExtensionMetadata($metadata);
    ...
    /**
     * @param ORMClassMetadata<ClientExtension> $metadata
     */
    private function buildClientExtensionMetadata(ORMClassMetadata $metadata): void
    {
