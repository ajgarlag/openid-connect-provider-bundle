...
final class TestKernel extends Kernel implements CompilerPassInterface
{
    public function __construct(
        string $environment,
        bool $debug,
        private readonly ?array $resourceServiceConfig = null,
        private readonly ?array $persistenceConfig = null,
    ) {
    ...
    public function registerContainerConfiguration(LoaderInterface $loader): void
    {
        $loader->load(function (ContainerBuilder $container): void {
            ...
            $doctrine['orm'] = ['enable_lazy_ghost_objects' => class_exists(RuntimeReflectionProperty::class)];
            ...
            $framework = [
                ...
                'test' => null,
                'router' => [
                    'resource' => __DIR__ . '/../vendor/league/oauth2-server-bundle/tests/Fixtures/routes.php',
                    'type' => 'php',
                    'utf8' => true,
                ],
